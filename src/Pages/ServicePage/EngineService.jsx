    ...
    return (
        <div className="flex flex-wrap lg:flex-nowrap">
            <div className="lg:w-2/3 w-full">
                <p className="text-[#737373] font-base mb-8 leading-[30px] w-full lg:w-[752px]">
                    There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.
                </p>
                <div className="flex flex-wrap gap-3">
                    <div className="w-full sm:w-[364px]">
                        <div className="w-full h-[204px] bg-[#F3F3F3] flex justify-center py-4 rounded-[10px] border border-t-[#FF3811] border-2 mb-3">
                        ...
                        <div className="w-full h-[204px] bg-[#F3F3F3] flex justify-center py-4 rounded-[10px] border border-t-[#FF3811] border-2">
                            <div className="w-[228px] h-[124px]">
                                <h4 className="text-xl text-[#444444] font-bold">Instant Car Services</h4>
                                <p className="text-base text-[#737373] mt-2">It uses a dictionary of over 200 Latin words, combined with a model sentence structures.</p>
                            </div>
                ...
                <div className="mt-4">
                    <p className="text-[#737373] font-base mt-[30px] leading-[30px] w-full lg:w-[752px]">
                        There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.
                    </p>
                </div>
                <div className="mt-6">
                    <h3 className="text-[#151515] text-[35px] font-bold my-[30px]">3 Simple Steps to Process</h3>
                    <p className="text-base text-[#737373] font-normal leading-[30px] w-full lg:w-[752px]">
                        There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.
                    </p>
                </div>
            </div>
            <div className="lg:ml-[35px] w-full lg:w-1/3">
                ...
                <div className="mt-4 w-full sm:w-[364px] h-[489px] bg-[#151515] flex justify-center py-4 rounded-[10px]">
                    <div className="w-[228px] h-[124px]">
