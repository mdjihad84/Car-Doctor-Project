...
const Manage = () => {
    ...
    const [buttonTexts, setButtonTexts] = useState(['Approved', 'Approved', 'Approved']);
    ...
    const handleSelection = (index, selection) => {
        ...
        newButtonTexts[index] = selection;
                    ...
                    <div className="relative w-full md:w-auto text-center md:text-left">
                        ...
                        {openDropdownIndex === index && (
                            <div className="absolute right-0 mt-2 w-full md:w-[160px] bg-white border border-gray-200 rounded-lg shadow-lg">
                                <ul className="py-2">
                                    <li
                                        onClick={() => handleSelection(index, 'Approve')}
                                        className="px-4 py-2 hover:bg-gray-100 cursor-pointer"
                                    >
                                        Approve
                                    </li>
                                    <li
                                        onClick={() => handleSelection(index, 'Reject')}
                                        className="px-4 py-2 hover:bg-gray-100 cursor-pointer"
                                    >
                                        Reject
                                    </li>
                                    <li
                                        onClick={() => handleSelection(index, 'Pending')}
                                        className="px-4 py-2 hover:bg-gray-100 cursor-pointer"
                                    >
                                        Pending
                                    </li>
