...
const Login = () => {
  return (
    <>
      ...
      <div className="flex flex-col justify-around lg:flex-row items-center mx-auto h-full bg-transparent">
        {/* Image section */}
        <div className="w-[90%] mt-[70px] lg:w-[460px] h-[502px] mt-[-50px] sm:mt-[-100px] md:mt-[-130px] lg:mt-[-170px]">
        ...
        <div className="mb-[200px] lg:w-[611px] p-8 lg:h-[730px] border-2 hover:border-blue-500 bg-transparent">
          <h1 className="font-bold text-center text-3xl text-black">Login</h1>
